...
public class PracticeWordsFragment extends BaseFragment {

    private static Context context;
    private ImageView iv_practice,iv_practice_show;
    private VideoView vv;

    public PracticeWordsFragment(){

    }

    public static PracticeWordsFragment newInstance(Context mContext){
        context = mContext;
        return new PracticeWordsFragment();
    }
    ...
    public View initView() {
        ...
        vv.setVideoPath(ContentsJson.BASE_ONE_JSON_VIDEO);
        initListener();
        initImage();
        return view;
    }
    ...
    private void initImage() {
        ...
        mmr.setDataSource(ContentsJson.BASE_ONE_JSON_VIDEO,new HashMap<String, String>());
